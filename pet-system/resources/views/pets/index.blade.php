        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    ...
                    <button type="button" class="btn-close text-danger" data-bs-dismiss="modal" aria-label="Close" style="filter: invert(28%) sepia(92%) saturate(7496%) hue-rotate(358deg) brightness(106%) contrast(122%);"></button>
                </div>
